-- Drop TikTok infrastructure.
--
-- Tim is no longer pursuing TikTok as an acquisition channel.
-- Drops the tiktok_comments table and removes the tiktok_daily_reminder
-- branch from derived_tasks_view. Everything else in the view is
-- identical to the previous definition in 20260523000100.
