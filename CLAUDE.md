...
- **$24 single coaching session — smoke test remaining.** Phase 1 + Tim-side surfacing + Phase 2 (parent-portal UX + scheduler + Stage C decline offer) all shipped 2026-05-23 (see Done entries). Open:
