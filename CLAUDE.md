...
8. **In-app messaging surface.** Locked in 2026-05-17 testing. Spec already supports it (`messages` table in initial schema; parent-visibility design in CLAUDE.md). Build:
